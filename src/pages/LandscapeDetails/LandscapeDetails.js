...
import { List, Col, Row, Input, Form, Avatar, Image } from "antd";
import TextArea from "antd/lib/input/TextArea";
import './LandscapeDetails.css';
...
const LandscapeDetails = () => {
  ...
  return (
    <div className="landscape_detail_container">
            ...
            <List.Item
              ...
              extra={
                <img
                  ...
                  alt="logo"
                  src="https://www.treehugger.com/thmb/yj5cBcqCVEO4Eea3bnYRSnJdnUU=/2121x1193/smart/filters:no_upscale()/GettyImages-1273584292-cbcd5f85f4c646d58f7a7fa158dcaaeb.jpg"
                />
              }
            >
              <List.Item.Meta title={<a href={item.href}>{item.title}</a>} />
              <div className="landscape_detail_bottom_border"></div>
              <p className="topic_details_content">{item.content}</p>
            </List.Item>
          )}
        />
      </div>
      <div className="landscape_details_content">
      <Row gutter={[32, 32]}>
        ...
        <Row>
              ...
              <Col xs={24} sm={24} md={24} lg={24} xl={24} className="landscape_details_linkedin_icon">
                <Image src={LinkedIn} />
              </Col>
              <Col xs={24} sm={24} md={24} lg={24} xl={24}>
                <Image src={Twitter} />
        ...
        <Col xs={24} sm={24} md={12} lg={12} xl={12}>
          <p className="landscape_paragraph">
            ...
            have focused on fast-growing, exotic species and timber production.
            This led to valid criticism over their claims of improving forest
            quality and human well-being. <br></br>
            <br></br>
            ...
            be counterproductive in the medium to long term. This contrasts with
            many traditional restoration initiatives in Asia that focused
            insufficiently on stakeholder engagement, if at all.<br></br>
            <br></br>
            FLR also differs from other approaches in the way it recognizes
            complexity and uncertainty. Local needs, priorities and patterns of
            resource use change over time. External influences such as climate
            change, market forces and policies make them even less predictable.
            FLR needs to be grounded in an adaptive management process that
            includes iterative monitoring and learning. This was not often the
            choice of large-scale top-down restoration projects.
          </p>
          <div className="landscape_detail_center_div">
            <h3 className="landscape_detail_sub_header">
              Landscape project: Location
            </h3>
            <p className="landscape_detail_letter">
              Sub: Arunachal Pradesh’s Dibang Valley Must Be Saved from
              Destruction <br></br>
              <br></br>
              The proposal for the Etalin Hydro-Electric Project (3097 MW) in
              Arunachal Pradesh’s Dibang Valley (RO/Ministry File Number F. No.
              8-20/2014-FC), was placed for approval before the Forest Advisory
              Committee on the 23rd of April, 2020. Long-term research in Dibang
              Valley (including areas which will see impacts of the proposed
              hydro-project) show that the region is a very important habitat
              for many Schedule I endangered species, including a genetically
              distinct population of tigers, 75 species of other mammals and
              over 300 species of birds. <br></br>
              <br></br>
              The proposed hydro-electric project is, in my opinion, detrimental
              to India’s biodiversity and ecological security, and therefore I
              respectfully request that the FAC reject it.<br></br>
              <br></br>
              Yours truly, The undersigned
            </p>
          </div>

          <div className="landscape_detail_center_divs">

          </div>

          <div className="landscape_detail_center_div">
            <h3 className="landscape_detail_sub_header">Area Covered</h3>
            <p className="landscape_detail_letter">
              Sub: Arunachal Pradesh’s Dibang Valley Must Be Saved from
              Destruction <br></br>
              <br></br>
        ...
        <Col xs={24} sm={24} md={8} lg={8} xl={8}>
          <p className="landscape_details_authors">Similar Authors</p>
